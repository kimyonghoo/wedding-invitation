    ...
    <section className={`snap-section relative w-full h-[100dvh] flex flex-col items-center justify-center overflow-hidden`}>
      ...
      <div className="absolute top-[10vh] w-full z-20 flex flex-col items-center text-center px-4">
        ...
        <motion.p
          ...
          className={`${koreanFont.className} text-[10px] md:text-xs tracking-[0.4em] uppercase mb-4 font-medium text-stone-500`}
        >
          We Are Getting Married
        </motion.p>

        {/* [수정] 이름 영역: 가로 유지 + 폰트 작게 + 자간 넓게 */}
        <motion.h1
        ...
        >
          ...
          {/* & 기호 */}
          <span className={`${englishFont.className} text-sm md:text-xl text-amber-800/60 italic font-normal mt-1`}>
            &
          </span>
        ...
        <motion.p
           ...
           className={`${koreanFont.className} text-xs md:text-sm font-medium text-stone-600 tracking-widest leading-relaxed`}
        >
          저희 두 사람, 결혼합니다.
        </motion.p>
      </div>
      ...
      >
        <div className="absolute top-0 flex flex-col items-center w-full">
            ...
            <motion.div
              ...
              className="w-[1px] bg-stone-100 origin-top shadow-[1px_0_2px_rgba(0,0,0,0.1)]"
            />
        </div>
      ...
      <motion.div 
        ...
        transition={{ 
            ...
            opacity: { repeat: Infinity, duration: 2, ease: "easeInOut", delay: 4.5 }
        }}
